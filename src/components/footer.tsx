...
const Footer = () => {
  return (
    <footer className="px-6 py-5 md:px-3 md:py-5 mt-auto bg-slate-100 min-h-[150px] flex flex-col justify-center">
      <div className="container mx-auto flex justify-between items-center">
        <p className="text-sm">© Copyright 2024 poketify. All rights reserved</p>
      </div>
          ...
          return (
            <div key={index} className="flex items-center mx-0 space-x-2 xs:ms-4">
              <a
                ...
                className="flex items-center space-x-1 no-underline md:space-x-2 hover:no-underline"
              >
                <FaGithub size={20} />
